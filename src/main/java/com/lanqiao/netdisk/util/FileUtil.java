...
public class FileUtil {
    ...
    public static final String[] DOC_FILE =
            {"doc", "docx", "ppt", "pptx", "xls", "xlsx", "txt", "hlp", "wps", "rtf", "html", "pdf"};
    public static final String[] VIDEO_FILE =
            {"avi", "mp4", "mpg", "mov", "swf"};
    public static final String[] MUSIC_FILE =
            {"wav", "aif", "au", "mp3", "ram", "wma", "mmf", "amr", "aac", "flac"};

    public static final int IMAGE_TYPE = 1;     //图片文件
    public static final int DOC_TYPE = 2;       //文档类型
    public static final int VIDEO_TYPE = 3;     //视频类型
    public static final int MUSIC_TYPE = 4;     //音乐文件
    public static final int OTHER_TYPE = 5;     //其他类型
    public static final int SHARE_FILE = 6;     //分享文件
    public static final int RECYCLE_FILE = 7;   //再利用文件
    ...
    public static boolean isImageFile(String extendName) {
        for (int i = 0; i < IMG_FILE.length; i++) {
            if (extendName.equalsIgnoreCase(IMG_FILE[i]))   return true;
        }
        return false;
    }

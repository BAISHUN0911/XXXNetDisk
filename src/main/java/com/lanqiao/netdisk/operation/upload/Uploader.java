package com.lanqiao.netdisk.operation.upload;
...
public abstract class Uploader {
    ...
    protected String getSaveFilePath() {
        ...
        if (!dir.exists()) {        //如果这个路径实例化出来的File对象不存在，则尝试创建这个目录
            try {
    ...
    /**
     * 获取文件名，例如传入的fileName为：c-block.mp4，return c-block
     * 如果传入fileName为：c-block，return c-block
     * @param fileName
     * @return
     */
